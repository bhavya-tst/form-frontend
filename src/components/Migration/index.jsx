...
export default function Migration() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-2xl font-bold text-white">Migration Tool</h2>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <Card
          className="border border-gray-800 shadow-soft"
          title={
            <div className="flex items-center gap-2">
              <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-blue-900/40 to-blue-800/40 flex items-center justify-center">
        ...
        <Card
          ...
          title={
            <div className="flex items-center gap-2">
              <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-primary-900/40 to-primary-800/40 flex items-center justify-center">
                <SwapOutlined className="text-primary-400" />
              </div>
        ...
        >
          <div className="space-y-4">
            <div className="flex items-center justify-center py-8">
              <div className="text-center">
                <ArrowRightOutlined className="text-primary-400 mb-4" />
            ...
            {sourceFormId && targetFormId && (
              <div className="space-y-3">
                ...
                <div className="flex items-center justify-between p-3 bg-primary-900/20 rounded-lg border border-primary-800">
        ...
        <Card
          ...
          title={
            <div className="flex items-center gap-2">
              <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-green-900/40 to-green-800/40 flex items-center justify-center">
          ...
          <div className="space-y-6">
            ...
            {sourceFormId && targetFormId && (
              <Button
                ...
                className="mt-6 bg-gradient-to-r from-primary-500 to-primary-600 hover:from-primary-600 hover:to-primary-700 border-0 shadow-md h-12 font-semibold"
              >
      ...
      <Card className="border border-gray-800 shadow-soft bg-gradient-to-br from-primary-900/10 to-gray-900">
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="space-y-2">
              <div className="w-10 h-10 rounded-lg bg-primary-900/40 flex items-center justify-center text-primary-400 font-bold">
                1
              </div>
              <h4 className="font-medium text-white">Select Source</h4>
              <p className="text-gray-400">
            ...
            <div className="space-y-2">
              ...
              <h4 className="font-medium text-white">Choose Target</h4>
              <p className="text-gray-400">
            ...
            <div className="space-y-2">
              ...
              <h4 className="font-medium text-white">Execute Migration</h4>
              <p className="text-gray-400">
